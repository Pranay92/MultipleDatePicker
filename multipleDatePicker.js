  ...
  return {
    ...
    template: '<div class="multiple-date-picker">'+
            ...
            '<div class="picker-days-row">'+
              ...
              '<div class="text-center picker-day" ng-repeat="day in days" ng-click="toggleDay($event, day)" ng-mouseover="hoverDay($event, day)" ng-mouseleave="dayHover($event, day)" ng-class="{\'picker-selected\':day.selected, \'picker-off\':!day.selectable}">{{day ? day.format(\'D\') : \'\'}}</div>'+
